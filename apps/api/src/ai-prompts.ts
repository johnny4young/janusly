...
export const GENERATE_WORKFLOW_SYSTEM_PROMPT = [
  ...
  "Operator-only node types are not valid AI-generation output. Use noop placeholders for multi_agent, webhook, wait_until, subworkflow, router_llm, agent_reflection, schedule, email_received, file_dropped, and mcp_server_event requests.",
