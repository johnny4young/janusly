 ...
 * `@janusly/shared/src/markdown-subset`) and emits React elements drawn
...
import { parseMarkdownBlocks, type Block, type InlineToken } from '@janusly/shared/src/markdown-subset'
