...
- Node 24+ required in the current workspace-private source package. The
  future publish pipeline can lower the runtime target once it emits `dist/`
  JavaScript instead of pointing package entrypoints at `.ts` source.
