...
var baseRouteAuthz = map[string]routeGate{
	...
	"GET /v1/workflows/versions/{versionId}": {auth.RoleViewer, "workflows.read"},
	...
	"GET /recovery/drills/dossier":                 {auth.RoleViewer, "reports.read"},
	...
	"GET /v1/recovery/home":                        {auth.RoleViewer, "recovery.read"},
	"POST /v1/recovery/playbooks/{id}/use":         {auth.RoleEditor, "recovery.write"},
	...
	"GET /v1/workflows/health/delta":               {auth.RoleViewer, "workflows.read"},
	...
	"POST /v1/workflows/{workflowId}/rollout":                        {auth.RoleAdmin, "workflows.write"},
	"POST /v1/workflows/{workflowId}/rollout/{rolloutId}/{decision}": {auth.RoleAdmin, "workflows.write"},
	"GET /v1/workflows/{workflowId}/rollout/qualification":           {auth.RoleViewer, "workflows.read"},
	"POST /v1/workflows/{workflowId}/rollout/qualification":          {auth.RoleAdmin, "workflows.write"},
	...
	"POST /v1/ai/patch-workflow": {auth.RoleEditor, "ai.write"},
