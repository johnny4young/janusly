 ...
 *
 * Some types here mirror server-side schemas declared in `src/lib`
 * (the workflow contract) and the backend tool registry (the
 ...
 * `inputs` shape. Mirrors `WorkflowInputSchemaShape` in `src/lib`.
