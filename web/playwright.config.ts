...
// The full-stack E2E harness may set this private variable independently from
// the documented PLAYWRIGHT_BASE_URL used by browser-only runs.
...
export default defineConfig({
  ...
  fullyParallel: false,
  // Every file shares one API, worker, and Postgres stack. Bounding the
