export const en = {
  ...
  product: {
    ...
    lede: 'Three surfaces, one runtime, no diagrams: each card below is what the operator actually clicks.',
    tabs: { recovery: 'Recovery Center', studio: 'AI Studio', operations: 'Operations' },
    cluster: {
      kicker: 'Failure cluster',
      count: '14 runs',
      title: 'notify_owner · HTTP 429 from Slack',
      cause: 'Cause',
    ...
    healing: {
      kicker: 'Auto-healing',
      validated: 'Validated on 1 sample',
      title: 'Add retry with backoff before notify_owner',
      body: "Proposed from the cluster's evidence. Runs against one failed sample first; the rest replay only after it passes and you approve.",
      approve: 'Approve and replay 13',
      reject: 'Reject',
    },
    operations: {
      kicker: 'Operations',
      window: 'last 24h',
      queueLag: 'Queue lag p95',
      recovered: 'Runs recovered',
      spend: 'AI spend',
      budgetLeft: 'Budget left',
      note: 'Prometheus scrape on :9464, traces to your OpenTelemetry collector, alert policies to Slack, email or a webhook.',
    },
    sampleNote: 'Sample values; screenshots per surface land before launch.',
  },
  compare: {
    kicker: 'Compare',
