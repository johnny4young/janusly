...
for the Node/Go contracts, lockfiles, audit, and cutover runbook. A dirty tree,
stale receipt, unintegrated `origin/main` patch, moved Node oracle, or failed
local check blocks review readiness.
...
3. write-safe shadow comparison;
4. gradual canary progression with stop thresholds; and
5. an executed rollback rehearsal.
