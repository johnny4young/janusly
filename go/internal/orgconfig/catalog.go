...
var Definitions = []Definition{
	...
	{Key: "mcp.stdioMaxVmKb", Category: "mcp", Description: "Max virtual-memory size (KB) enforced via Linux ulimit -v on stdio MCP children. Applied only on Linux when JANUSLY_MCP_SANDBOX_ENFORCE_LINUX is true; macOS / Windows ignore this value. Range 131072..4194304 (128 MiB..4 GiB).", ValueType: "number", Default: float64(524288), EnvKeys: []string{"JANUSLY_MCP_STDIO_MAX_VM_KB"}, Min: new(float64(131072)), Max: new(float64(4194304))},
